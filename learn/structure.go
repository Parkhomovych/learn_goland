...
// - функції з вказівниками на структури "*"
...
func Structure() {
	...
	changeAge(&vlad) // Змінюємо вік за допомогою функції з вказівником
...
// changeAge - функція, що демонструє роботу з вказівниками на структури
// Приймає вказівник на Person і збільшує вік на 1
// Зміни відображаються в оригінальному об'єкті
